...
user in an INI file next to VSCodePortable64.exe called VSCodePortable64.ini.
...
copy AppNamePortable.ini from this directory to VSCodePortable64.ini next to
VSCodePortable64.exe. The options in the INI file are as follows:
